...
<script>
    let cursoComprado = false; // Cambia esto a true si el curso ha sido comprado

    if (cursoComprado) {
        document.getElementById('add-comment-section').style.display = 'block'; // Mostrar sección de comentarios
    } else {
        document.getElementById('add-comment-section').style.display = 'none'; // Asegurarse que esté oculta
    }
</script>
